...
public class shuangren extends Activity implements View.OnClickListener{

    private ImageView mBtn;
    private Button mStart;
    private EditText xueHao1,yanZhengma1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shuangren);

        mBtn=(ImageView)findViewById(R.id.title_back);
        mBtn.setOnClickListener(this);

        mStart=(Button) findViewById(R.id.login1);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.title_back){
            ...
            editor.commit();
            //跳转到页
            Intent intent = new Intent(shuangren.this, studentnumber.class);
            startActivity(intent);
            //关闭当前界面
            finish();
        }
        if(v.getId()==R.id.login1){
            xueHao1=(EditText)findViewById(R.id.xuehao1);
            yanZhengma1=(EditText)findViewById(R.id.number1);
            // 存储同学1信息
                ...
                case SUCCESS:
                    ...
                    try {
                        ...
                        if(errcode==0){
                            if(xueHao1.getText().toString().length() != 0){
                                if(yanZhengma1.getText().toString().length() != 0){
                                    Toast.makeText(shuangren.this, "选宿舍成功", Toast.LENGTH_LONG).show();
                                    //跳转到页
                                    Intent intent = new Intent(shuangren.this, success.class);
                                    startActivity(intent);
                                    finish();
                                }else {
                                    Toast.makeText(shuangren.this, "请输入第二位同学的验证码", Toast.LENGTH_LONG).show();
                                }
                            }else {
                                Toast.makeText(shuangren.this, "请输入第二位同学的学号", Toast.LENGTH_LONG).show();
                            }

                        }else{
                            Toast.makeText(shuangren.this, "选宿舍失败，请重新选宿舍", Toast.LENGTH_LONG).show();
                        }
